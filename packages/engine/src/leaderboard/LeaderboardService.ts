...
const KEYS = {
  LEADERBOARD: 'clawdbot:leaderboard',
  PLAYER_DATA: 'clawdbot:player:', // + playerId
  ONLINE_PLAYERS: 'clawdbot:online',
  IN_MATCH_PLAYERS: 'clawdbot:in_match',
  LEADERBOARD_CHANNEL: 'clawdbot:leaderboard:updates',
};
